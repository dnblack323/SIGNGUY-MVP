...
| **EC13** | Commercial Billing, Entitlements, Fees, Trials, and Setup Packages | **IN PROGRESS - TESTING** | `EC13_Commercial_Billing_Fees_Trials_Setup_and_Entitlements.docx` | Old master plan Appendix A.4 / `REVISED_COMMERCIAL_SOURCE_OF_TRUTH_2026-07.md` (confirmed; C1/C2 contradictions RESOLVED 2026-02 - see hold register). Preflight: `/app/preflight/EC13_COMMERCIAL_BILLING_ENTITLEMENTS_FEES_TRIALS_AND_SETUP_PACKAGES_PREFLIGHT.md`. Phase 13A plan: `/app/preflight/EC13_PHASE13A_COMMERCIAL_BILLING_CATALOG_AND_CORE_CONTRACTS_PLAN.md`. Contracts: `/app/docs/commercial/ec13_commercial_catalog_contracts.md`; `/app/docs/commercial/ec13_billing_runtime_contracts.md`. Evidence: `/app/evidence/EC13_PHASE13A_COMPLETION_REPORT.md`; `/app/evidence/EC13_IMPLEMENTATION_COMPLETION_REPORT.md`. Phase 13A implementation commit `d5c545fe256d66fd9d7f798e834efa895160f00e`; CI `29637493631`. Full EC13 backend runtime implementation pending branch-head GitHub CI before COMPLETE status. | H1 closed for EC13 implementation only after CI passes; EC14+ remain held |
...
**EC13 update (2026-07-19):** EC13 preflight and Phase 13A are COMPLETE. Full EC13 backend runtime implementation is IN PROGRESS - TESTING and must not be marked COMPLETE until branch-head GitHub CI passes.

**Table last updated:** 2026-07-19 - EC9 and EC10 are COMPLETE / CLOSED. EC11 core is COMPLETE / CLOSED with Phases 11A, 11B, 11C, 11D, 11E, 11F, and 11I COMPLETE; phases 11G/11H are reserved and not authorized. EC12 is COMPLETE / CLOSED with Phases 12A-12I COMPLETE. EC13 full backend runtime is IN PROGRESS - TESTING pending branch-head GitHub CI. EC19 remains NOT STARTED.
