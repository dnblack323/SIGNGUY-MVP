...
**Table last updated:** 2026-07-17 — EC9 (Pricing Foundation, Calculators, and Order Pricing) Phases 9A-9H all COMPLETE; EC9 formally CLOSED. EC10 (Order Intake, Visual Markup, Customer Decision Room, and Templates) Phases 10A-10H all COMPLETE; EC10 formally CLOSED. EC11 core is COMPLETE / CLOSED with Phases 11A, 11B, 11C, 11D, 11E, 11F, and 11I COMPLETE; phases 11G/11H are reserved and not authorized; EC12 has not started.
