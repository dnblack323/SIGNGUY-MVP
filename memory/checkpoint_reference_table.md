...
| **EC12** | Tasks, Kanban, Messages, Notes, Calendar, Appointments, Shop Schedule, and Community | **IN PROGRESS - Phase 12A COMPLETE; Phase 12B IN PROGRESS** | `EC12_Productivity_Messaging_Calendar_Appointments_and_Community.docx` | Phase 12A shared task foundation evidence: `/app/evidence/EC12_PHASE12A_COMPLETION_REPORT.md`. Phase 12B task list/Kanban/My Tasks/handoff evidence: `/app/evidence/EC12_PHASE12B_COMPLETION_REPORT.md`. | H1 remains for Phase 12C+ |
...
**Table last updated:** 2026-07-17 — EC9 (Pricing Foundation, Calculators, and Order Pricing) Phases 9A-9H all COMPLETE; EC9 formally CLOSED. EC10 (Order Intake, Visual Markup, Customer Decision Room, and Templates) Phases 10A-10H all COMPLETE; EC10 formally CLOSED. EC11 core is COMPLETE / CLOSED with Phases 11A, 11B, 11C, 11D, 11E, 11F, and 11I COMPLETE; phases 11G/11H are reserved and not authorized; EC12 Phase 12A is COMPLETE; Phase 12B is IN PROGRESS pending CI.
