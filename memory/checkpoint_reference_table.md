...
| **EC10** | Order Intake, Visual Markup, Customer Decision Room, and Templates | **IN PROGRESS — Phase 10A/10B/10C/10D COMPLETE; Phase 10E CLOSED (10E-1..10E-5 COMPLETE); Phase 10F NOT STARTED** | `EC10_Order_Intake_Visual_Markup_Decision_Room_and_Templates.docx` | Old master plan Appendix A.1 (EC6.3 Order Intake/Visual Markup); adds the new Customer Decision Room + reusable Templates. Evidence through Phase 10E closure: `/app/evidence/EC10_PHASE10E_CLOSURE_REPORT.md`. EC10 itself is not closed because Phase 10F, Phase 10G, and final EC10 closure remain unfinished. | H1 |
...
**Table last updated:** 2026-07-16 — EC9 (Pricing Foundation, Calculators, and Order Pricing) Phases 9A-9H all COMPLETE; EC9 formally CLOSED. EC10 is in progress through Phase 10E closure: Phase 10A, 10B, 10C, 10D, and 10E (10E-1..10E-5) are complete; Phase 10F has not started.
