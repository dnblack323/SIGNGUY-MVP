...
| **EC13** | Commercial Billing, Entitlements, Fees, Trials, and Setup Packages | **PREFLIGHT COMPLETE / 13A IMPLEMENTED / CI PENDING** | `EC13_Commercial_Billing_Fees_Trials_Setup_and_Entitlements.docx` | Old master plan Appendix A.4 / `REVISED_COMMERCIAL_SOURCE_OF_TRUTH_2026-07.md` (confirmed; C1/C2 contradictions RESOLVED 2026-02 — see hold register). Preflight: `/app/preflight/EC13_COMMERCIAL_BILLING_ENTITLEMENTS_FEES_TRIALS_AND_SETUP_PACKAGES_PREFLIGHT.md`. Phase 13A plan: `/app/preflight/EC13_PHASE13A_COMMERCIAL_BILLING_CATALOG_AND_CORE_CONTRACTS_PLAN.md`. Contracts: `/app/docs/commercial/ec13_commercial_catalog_contracts.md`. Evidence: `/app/evidence/EC13_PHASE13A_COMPLETION_REPORT.md`. | H1 remains for later EC13 phases |
...
**EC13 update (2026-07-18):** EC13 preflight is accepted COMPLETE, the Phase 13A commercial billing catalog/core-contracts plan is complete at `/app/preflight/EC13_PHASE13A_COMMERCIAL_BILLING_CATALOG_AND_CORE_CONTRACTS_PLAN.md`, and Phase 13A implementation is prepared pending GitHub CI. Do not mark Phase 13A complete until CI passes.

**Table last updated:** 2026-07-18 — EC9 and EC10 are COMPLETE / CLOSED. EC11 core is COMPLETE / CLOSED with Phases 11A, 11B, 11C, 11D, 11E, 11F, and 11I COMPLETE; phases 11G/11H are reserved and not authorized. EC12 is COMPLETE / CLOSED with Phases 12A-12I COMPLETE. EC13 preflight is COMPLETE; Phase 13A implementation is prepared pending GitHub CI. EC19 remains NOT STARTED.
