...
| **EC11** | Production Timeline, Workflow Configuration, Stage Tracking, and Kiosk | **IN PROGRESS — Phase 11A COMPLETE (2026-07-16); Phase 11B COMPLETE (2026-07-16); Phase 11C COMPLETE (2026-07-16); Phase 11D NOT STARTED** | `EC11_Production_Timeline_Workflows_Kiosk_and_Advanced_Tracking.docx` | Phase 11A evidence: `/app/evidence/EC11_PHASE11A_COMPLETION_REPORT.md`. Phase 11B evidence: `/app/evidence/EC11_PHASE11B_COMPLETION_REPORT.md`. Phase 11C evidence: `/app/evidence/EC11_PHASE11C_COMPLETION_REPORT.md`. Advanced Production Tracking & Bottleneck Analytics Add-On remains reserved; phases 11G/11H are NOT AUTHORIZED. | H1 lifted for Phases 11A, 11B, and 11C only; H1 remains for Phase 11D+ |
...
**Table last updated:** 2026-07-16 — EC9 (Pricing Foundation, Calculators, and Order Pricing) Phases 9A-9H all COMPLETE; EC9 formally CLOSED. EC10 (Order Intake, Visual Markup, Customer Decision Room, and Templates) Phases 10A-10H all COMPLETE; EC10 formally CLOSED. EC11 is IN PROGRESS with Phases 11A, 11B, and 11C COMPLETE; Phase 11D has not started; phases 11G/11H are not authorized.
