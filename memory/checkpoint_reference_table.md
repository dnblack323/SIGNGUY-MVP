...
|---|---|---|---|---|---|
| **EC9** | Pricing Foundation, Detailed Calculators, and Exact Order Workflow | **PREFLIGHT COMPLETE — AWAITING OWNER APPROVAL TO CODE** | `EC09_Pricing_Foundation_Calculators_and_Order_Pricing.docx` | Old master plan Appendix A.2 (EC3.1 Pricing Foundation Verification). Preflight: `/app/preflight/EC9_PRICING_FOUNDATION_CALCULATORS_AND_ORDER_PRICING_PREFLIGHT.md` | H1 |
