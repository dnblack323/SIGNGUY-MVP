...
| EC9–EC22 (new numbering) | **EC9 Phases 9A–9D COMPLETE (2026-07)**; Phases 9E–9H not started | Controlling docs at `/app/specs_pack/extracted/*.docx`. Full status/holds table: `/app/memory/checkpoint_reference_table.md`. Active owner holds: `/app/memory/owner_specification_hold_register.md`. |
...
- EC9 Phases 9A–9D are COMPLETE. Foundation Hardening pass (external review fixes) is COMPLETE. Next: **Phase 9E — Category calculators** (owner must explicitly authorize before starting, per standing sequential-phase rule).
...
- EC9 Phase 9E — Category calculators (formula implementation) — NOT STARTED.
