...
| **EC10** | Order Intake, Visual Markup, Customer Decision Room, and Templates | **Phase 10A/10B/10C/10D COMPLETE; Phase 10E split into 10E-1..10E-5 — 10E-1 COMPLETE (2026-02); Phase 10E-2 onward NOT STARTED** | Absorbs old Appendix A.1 (EC6.3); adds the previously-missing Customer Decision Room + Templates system. Controlling doc: `EC10_Order_Intake_Visual_Markup_Decision_Room_and_Templates.docx`. Held on H1 pending explicit per-(sub)phase owner authorization. Evidence: `/app/evidence/EC10_PHASE10A_COMPLETION_REPORT.md`, `/app/evidence/EC10_PHASE10B_COMPLETION_REPORT.md`, `/app/evidence/EC10_PHASE10C_COMPLETION_REPORT.md`, `/app/evidence/EC10_PHASE10D_COMPLETION_REPORT.md`, `/app/evidence/EC10_PHASE10E1_COMPLETION_REPORT.md`. |
