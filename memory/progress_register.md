...
| **EC11** | Production Timeline, Workflow Configuration, Stage Tracking, and Kiosk | **IN PROGRESS — Phase 11A COMPLETE (2026-07-16); Phase 11B NOT STARTED** | Controlling doc: `EC11_Production_Timeline_Workflows_Kiosk_and_Advanced_Tracking.docx`. Phase 11A adds tenant-scoped Production Workflow Definitions and canonical stage contracts only; evidence: `/app/evidence/EC11_PHASE11A_COMPLETION_REPORT.md`. Advanced/paid phases 11G/11H remain NOT AUTHORIZED. EC12 has not started. |
...
**EC8 is DELIVERED / CLOSED (all phases 8a–8f complete). EC9 is COMPLETE / CLOSED (all phases 9A–9H complete, 2026-07) — owner formally accepted closure 2026-02. EC10 is COMPLETE / CLOSED (all phases 10A–10H complete, 2026-07-16). EC11 is IN PROGRESS; Phase 11A is COMPLETE and Phase 11B has NOT started.** See `/app/evidence/EC11_PHASE11A_COMPLETION_REPORT.md`.

- The remaining roadmap (EC11 Phase 11B and EC12–EC22) is now governed by the SignGuy AI Checkpoint Specification Pack — see `/app/memory/checkpoint_reference_table.md`.
- Do NOT begin EC11 Phase 11B or any later phase/subphase/checkpoint implementation without explicit owner authorization naming that phase (hold H1).
...
**Register last updated:** 2026-07-16 — **EC11 IN PROGRESS; Phase 11A COMPLETE; Phase 11B NOT STARTED** — see `/app/evidence/EC11_PHASE11A_COMPLETION_REPORT.md`. EC10 remains COMPLETE / CLOSED. Advanced EC11 phases 11G/11H are NOT AUTHORIZED. EC12 has NOT started.
