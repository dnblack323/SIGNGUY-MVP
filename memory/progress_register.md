...
| **EC7** | Inventory, Purchasing, Finance, and Reporting | **IN PROGRESS (7a+7b+7c+7d backend+frontend delivered; regression pending)** | Phase 7a: Materials + Inventory + Movements. Phase 7b: Vendors + 80-SKU deterministic supplier catalog + Purchase Orders + Receiving. Phase 7c: Expenses + Categories + labeled-basis Finance Dashboard (17 metrics) + Tax reports. Phase 7d: Curated reports (13) + Custom Report Builder foundation + CSV export (formula-injection neutralized) + full EC7 frontend (Inventory, Supply Center, Purchase Orders, Expenses, Finance Dashboard, Tax Reports, Reports). 215/215 backend tests. `testing_agent_v3_fork` regression PENDING — EC7 remains IN PROGRESS. |
