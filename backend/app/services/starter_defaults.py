...
CATEGORY_DEFAULTS: dict[str, dict[str, Any]] = {
    "banners": _make_category(
        ...
        extras={
            "default_pricing_method": "square_foot_plus_addons",
            "enabled_pricing_methods": [
                "square_foot_plus_addons",
                "cost_plus",
                "target_margin",
            ...
            "use_highest_enabled_method": False,
            "hems_grommets_included": True,
            "grommet_sell_price_each": 0.75,
            "grommet_internal_cost_each": 0.20,
            ...
            "hem_charge_per_linear_ft": 0.75,
            "hem_internal_cost_per_linear_ft": 0.35,
