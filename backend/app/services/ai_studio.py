...
TOOL_CATALOG: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "modes": [
            ...
            _mode("job_update", "Project Update", usage_band="standard", result_storage="editable_draft", capability_key="studio.text.email_draft", fields=[TEXT_FIELD]),
            _mode("job_complete_email", "Project-Complete Email", usage_band="standard", result_storage="editable_draft", capability_key="studio.text.email_draft", fields=[TEXT_FIELD]),
    ...
    },
    {
        ...
        "modes": [
            ...
            _mode("job_description", "Project Description", usage_band="heavy", result_storage="generated_asset", capability_key="studio.text.document_draft", fields=[TEXT_FIELD]),
