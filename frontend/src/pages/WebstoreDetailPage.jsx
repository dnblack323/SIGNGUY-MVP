...
function editableAnswerValue(value) {
...
export default function WebstoreDetailPage() {
  ...
  const artworkOptions = useQuery({
    queryKey: ["webstore-artwork", id, selectedProductId],
    queryFn: () =>
      listWebstoreArtwork(
        id,
  ...
  const mockupOptions = useQuery({
    queryKey: ["webstore-mockups", id, selectedProductId],
    queryFn: () =>
      listWebstoreMockups(
        id,
        selectedProductId ? { product_id: selectedProductId } : {},
  ...
  const addBundleItem = (productId) => {
    ...
    const bundled = (detail.data?.products || []).find(
  ...
  const formatActivityLabel = (value) =>
    formatLabel(String(value || "activity").replace(/^webstore\./, ""));
          ...
          >
            <div className="grid grid-cols-1 xl:grid-cols-[1.1fr_1.4fr] gap-4">
              ...
              <Card data-testid="webstore-product-editor">
                <CardHeader>
                  <CardTitle className="text-base">
                    Focused Product Setup
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  {!productDraft.id ? (
                    <div className="text-sm text-muted-foreground">
                      Select a product or create a draft to edit product
                      foundation fields.
                    </div>
                  ) : (
                    <>
