...
export function buildIntakeRibbonGroups({ canWrite, onNewIntake }) {
  return [
    {
      id: "primary",
      label: "Primary",
      commands: [
        {
          ...
          onSelect: onNewIntake,
          to: onNewIntake ? undefined : "/intake/new",
          disabled: !!onNewIntake && !canWrite,
          disabledReason: "Intake write permission required",
          tooltip: "Capture a new sales intake request",
          responsivePriority: 1,
          testId: "ribbon-new-intake",
        },
      ],
    },
    {
...
export function buildQuotesRibbonGroups({ canWrite, onNewQuote }) {
  return [
    {
      id: "primary",
      label: "Primary",
      commands: [
        {
          ...
          permission: "quote:write",
          onSelect: onNewQuote,
          to: onNewQuote ? undefined : "/quotes",
          disabled: !!onNewQuote && !canWrite,
          disabledReason: "Quote write permission required",
          tooltip: "Create a Quote",
          responsivePriority: 1,
          testId: "ribbon-new-quote",
        },
      ],
    },
    {
...
export function buildProductionRibbonGroups() {
  return [
    {
      id: "primary",
      label: "Primary",
      commands: [
        navCommand({
          ...
          tooltip: "Open the Production Board",
          responsivePriority: 1,
        }),
      ],
    },
