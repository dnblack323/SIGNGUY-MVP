...
export const PRIMARY_NAV_AREAS = [
  ...
  },
  {
    ...
    moduleNav: [
      { key: "overview", label: "Overview", to: "/", perm: null, testId: "module-nav-shop-overview" },
      { key: "sales", label: "Sales", to: "/intake", perm: "intake:read", testId: "module-nav-sales", match: ["/intake", "/customers", "/quotes", "/orders"] },
      ...
      { key: "materials", label: "Materials", to: "/inventory", perm: "inventory:read", testId: "module-nav-materials", match: ["/inventory", "/materials", "/supply-center", "/purchase-orders", "/vendors"] },
      { key: "webstores", label: "Webstores", to: "/webstores", perm: "webstore:read", testId: "module-nav-webstores" },
      { key: "wrap-lab", label: "Wrap Lab", to: "/wrap-lab", perm: "wrap_lab:read", testId: "module-nav-wrap-lab" },
