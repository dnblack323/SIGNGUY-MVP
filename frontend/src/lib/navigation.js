...
export const NAV_AREAS = [
  ...
  },
  {
    ...
    flyout: [
      ...
      { key: "inventory-purchasing", label: "Inventory & Purchasing", to: "/inventory-purchasing", perm: "inventory:read", testId: "flyout-inventory-purchasing", disabled: true },
  ...
  },
  {
    ...
    perm: null,
    flyout: [
      { key: "overview", label: "Overview", to: "/business-finance", perm: null, testId: "flyout-bf-overview", disabled: true },
      { key: "financials", label: "Financials", to: "/business-finance/financials", perm: "invoice:read", testId: "flyout-financials", disabled: true },
      { key: "sales", label: "Sales", to: "/business-finance/sales", perm: "invoice:read", testId: "flyout-sales", disabled: true },
      { key: "expenses", label: "Expenses", to: "/business-finance/expenses", perm: "invoice:read", testId: "flyout-expenses", disabled: true },
      { key: "taxes", label: "Taxes", to: "/business-finance/taxes", perm: "invoice:read", testId: "flyout-taxes", disabled: true },
      { key: "reports", label: "Reports", to: "/business-finance/reports", perm: "report:read", testId: "flyout-reports", disabled: true },
  ...
  },
  {
    ...
    perm: null,
    flyout: [
      { key: "overview", label: "Overview", to: "/team", perm: null, testId: "flyout-team-overview", disabled: true },
      { key: "employees", label: "Employees", to: "/team/employees", perm: "employee:read", testId: "flyout-employees", disabled: true },
      { key: "tasks-kanban", label: "Tasks & Kanban", to: "/team/tasks", perm: "task:read", testId: "flyout-tasks-kanban", disabled: true },
      { key: "team-schedule", label: "Team Schedule", to: "/team/schedule", perm: "schedule:read", testId: "flyout-team-schedule", disabled: true },
      { key: "time-clock", label: "Time Clock", to: "/team/time-clock", perm: "time_clock:read", testId: "flyout-time-clock", disabled: true },
      { key: "timesheets", label: "Timesheets", to: "/team/timesheets", perm: "timesheet:read", testId: "flyout-timesheets", disabled: true },
      ...
      { key: "announcements", label: "Announcements", to: "/team/announcements", perm: null, testId: "flyout-announcements", disabled: true },
      { key: "employee-portal", label: "Employee Portal", to: "/team/employee-portal", perm: "employee:admin", testId: "flyout-employee-portal", disabled: true },
    ],
  },
  {
    key: "creative-studio",
  ...
  },
  {
    ...
    flyout: [
      ...
      { key: "company-settings", label: "Company Settings", to: "/settings", perm: null, testId: "flyout-company-settings" },
      ...
      { key: "integrations", label: "Integrations", to: "/settings/integrations", perm: "integration:read", testId: "flyout-integrations", disabled: true },
      ...
      { key: "feature-access", label: "Feature Access", to: "/settings/features", perm: "settings:read", testId: "flyout-feature-access", disabled: true },
