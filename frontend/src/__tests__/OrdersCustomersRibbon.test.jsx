...
test("Orders page uses shared ribbon and canonical source filters without reserved sources", async () => {
  ...
  expect(screen.getByTestId("sales-page-tabs")).toBeInTheDocument();
  expect(screen.getByTestId("sales-tab-orders")).toHaveAttribute("aria-current", "page");
  expect(screen.getByTestId("orders-status-filters")).toBeInTheDocument();
...
test("Customers page uses shared ribbon while preserving search", async () => {
  ...
  expect(screen.getByTestId("sales-page-tabs")).toBeInTheDocument();
  expect(screen.getByTestId("sales-tab-customers")).toHaveAttribute("aria-current", "page");
